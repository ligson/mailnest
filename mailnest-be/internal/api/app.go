...
func (a *App) Routes() http.Handler {
	...
	mux.Handle("GET /api/v1/messages/{id}/rule-logs", a.authMiddleware(http.HandlerFunc(a.handleMessageRuleLogs)))
	...
	mux.Handle("GET /api/v1/drafts", a.authMiddleware(http.HandlerFunc(a.handleListDrafts)))
	mux.Handle("POST /api/v1/drafts", a.authMiddleware(http.HandlerFunc(a.handleCreateDraft)))
	mux.Handle("GET /api/v1/drafts/{id}", a.authMiddleware(http.HandlerFunc(a.handleDraftDetail)))
	mux.Handle("PUT /api/v1/drafts/{id}", a.authMiddleware(http.HandlerFunc(a.handleUpdateDraft)))
	mux.Handle("DELETE /api/v1/drafts/{id}", a.authMiddleware(http.HandlerFunc(a.handleDeleteDraft)))
	mux.Handle("POST /api/v1/drafts/{id}/send", a.authMiddleware(http.HandlerFunc(a.handleSendDraft)))
	mux.Handle("GET /api/v1/threads", a.authMiddleware(http.HandlerFunc(a.handleListThreads)))
	mux.Handle("POST /api/v1/threads/rebuild", a.authMiddleware(http.HandlerFunc(a.handleRebuildThreads)))
	mux.Handle("GET /api/v1/threads/{id}", a.authMiddleware(http.HandlerFunc(a.handleThreadDetail)))
	mux.Handle("GET /api/v1/rule-logs", a.authMiddleware(http.HandlerFunc(a.handleListRuleLogs)))
	mux.Handle("GET /api/v1/attachments", a.authMiddleware(http.HandlerFunc(a.handleListAttachments)))
	mux.Handle("GET /api/v1/attachments/{id}/preview", a.authMiddleware(http.HandlerFunc(a.handleAttachmentPreview)))
	...
	mux.Handle("GET /api/v1/server-delete-logs", a.authMiddleware(http.HandlerFunc(a.handleListServerDeleteLogs)))
